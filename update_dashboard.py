...
".summary{display:grid;grid-template-columns:repeat(5,1fr);background:var(--surface);border-bottom:1px solid var(--border);}"
...
".cards{display:grid;grid-template-columns:repeat(5,1fr);background:var(--border);border-bottom:1px solid var(--border);gap:1px;}"
...
".exec-grid{display:grid;grid-template-columns:repeat(5,1fr);gap:14px;padding:24px 36px;background:var(--bg);}"
...
".exec-summary{display:grid;grid-template-columns:repeat(6,1fr);background:var(--surface);border-bottom:1px solid var(--border);border-top:1px solid var(--border);}"
...
html = (
    ...
    "<title>Central Bark Dashboard</title>"
    ...
    "document.querySelectorAll('.trend-week').forEach(p=>p.style.display=view==='week'?'':'none');"
    "document.querySelectorAll('.trend-month').forEach(p=>p.style.display=view==='month'?'':'none');}"
    "</script>"
    "</head><body>"
    "<header><div class=\"logo\">Central <span>Bark</span></div>"
    "<div class=\"meta\">Week of "+WEEK_LABEL+" &nbsp;&middot;&nbsp; Updated "+UPDATED+"</div></header>"
    "<div class=\"tabs\">"
    "<div class=\"tab active\" onclick=\"showTab('tab-exec',this)\">Executive View</div>"
    "<div class=\"tab\" onclick=\"showTab('tab-full',this)\">Full Detail</div>"
    "<div class=\"tab\" onclick=\"showTab('tab-gm',this)\">GM View</div>"
    "</div>"
    "<div id=\"tab-exec\" class=\"tab-content active\">"
    +alerts_html+
    "<div class=\"exec-summary\">"
    "<div class=\"exec-stat\"><div class=\"v green\">"+fmt(grand_exp)+"</div><div class=\"l\">Week Expected</div></div>"
    "<div class=\"exec-stat\"><div class=\"v "+unp_color+"\">"+fmt(grand_unp)+"</div><div class=\"l\">Unpaid</div></div>"
    "<div class=\"exec-stat\"><div class=\"v\">"+"{:,}".format(tot_dc)+"</div><div class=\"l\">Daycare Dogs</div></div>"
    "<div class=\"exec-stat\"><div class=\"v\">"+"{:,}".format(tot_bo)+"</div><div class=\"l\">Boarding Dogs</div></div>"
    "<div class=\"exec-stat\"><div class=\"v\">"+"{:,}".format(tot_gr)+"</div><div class=\"l\">Grooming Appts</div></div>"
    "<div class=\"exec-stat\"><div class=\"v\">"+fmt(grand_retail)+"</div><div class=\"l\">Retail WTD</div></div>"
    "</div>"
    "<div class=\"exec-grid\">"+exec_cards+"</div>"
    +"<div class=\"section\" style=\"background:var(--bg);\"><div class=\"section-title\">Today vs Benchmarks &mdash; "+day_name+"</div><div class=\"sc-grid\">"+scorecard_html+"</div></div>"+
    "</div>"
    "<div id=\"tab-full\" class=\"tab-content\">"
    "<div class=\"summary\">"
    "<div class=\"sstat\"><div class=\"v green\">"+fmt(grand_exp)+"</div><div class=\"l\">Week Expected</div></div>"
    "<div class=\"sstat\"><div class=\"v "+unp_color+"\">"+fmt(grand_unp)+"</div><div class=\"l\">Total Unpaid</div></div>"
    "<div class=\"sstat\"><div class=\"v\">"+"{:,}".format(tot_dc)+"</div><div class=\"l\">Daycare Dogs</div></div>"
    "<div class=\"sstat\"><div class=\"v\">"+"{:,}".format(tot_bo)+"</div><div class=\"l\">Boarding Dogs</div></div>"
    "<div class=\"sstat\"><div class=\"v\">"+"{:,}".format(tot_gr)+"</div><div class=\"l\">Grooming Appts</div></div>"
    "</div>"
    ...
    "<div class=\"note\">* Counts based on appointment start date</div></div>"
    ...
    "<tbody>"+unpaid_rows+"</tbody></table></div>"
    ...
    "<tbody>"+wow_rows+"</tbody></table></div>"
    ...
    "<tbody>"+retail_day_rows+"</tbody></table>"
    "<div style=\"margin-top:24px\"><div class=\"section-title\" style=\"margin-bottom:12px\">Top Selling Retail Items (All Locations)</div>"
    "<table><thead><tr><th>Item</th><th class=\"c\">Qty Sold</th><th class=\"r\">Revenue</th></tr></thead>"
    "<tbody>"+top_item_rows+"</tbody></table></div></div>"
    ...
    "<tbody>"+client_rows+"</tbody></table></div>"
    ...
    "<tbody>"+boarding_rows+"</tbody></table></div>"
    "</div>"
    ...
    "<div class=\"gm-grid\">"+gm_cards+"</div>"
    "</div>"
    "</body></html>"
)
